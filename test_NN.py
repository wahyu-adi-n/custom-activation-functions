...
act_funcs_dict = {'ReLU' : nn.ReLU(),
                    ...
                    'Dslope_0.25' : custom_act_funcs.DSlopeReLU(0.25),
                    #'Dslope_0.5' : custom_act_funcs.DSlopeReLU(0.5),
                    'Dslope_0.75' : custom_act_funcs.DSlopeReLU(0.75),
                    #'Dslope_1.0' : custom_act_funcs.DSlopeReLU(1.0),
                    'Dslope_1.25' : custom_act_funcs.DSlopeReLU(1.25),
                    #'Dslope_1.5' : custom_act_funcs.DSlopeReLU(1.5),
                    #'DiffYRelu_0.25' : custom_act_funcs.Diff_Y_ReLU(0.25),
                    'DiffYRelu_0.5' : custom_act_funcs.Diff_Y_ReLU(0.5),
                    #'DiffYRelu_0.75' : custom_act_funcs.Diff_Y_ReLU(0.75),
                    'DiffYRelu_1.0' : custom_act_funcs.Diff_Y_ReLU(1.0),
                    'PosHill_0.25' : custom_act_funcs.Pos_Hill(0.25),
                    'PosHill_0.5' : custom_act_funcs.Pos_Hill(0.5),
                    'PosHill_0.75' : custom_act_funcs.Pos_Hill(0.75),
                    'SmallNeg_0.1' : custom_act_funcs.Small_Neg(0.1),
                    #'SmallNeg_0.2' : custom_act_funcs.Small_Neg(0.2),
...
with open("Hill_test_results.csv", mode="w") as csv_file:
    ...
    #test each function 5 times in order to caluclate statistics
        ...
        #small model
            ...
            # torch.save(model.state_dict(), f"{text}_Hill_{i}.pth")
            # print(f"Saved PyTorch Model State to {text}_Hill_{i}.pth")
